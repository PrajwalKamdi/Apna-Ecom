...
function AllCollection() {
  ...
  return (
    <div className="mt-[80px] md:flex px-5 md:px-16">
      <div className="w-full lg:max-w-fit">
        ...
        <div className="px-5 py-3 border">
          ...
          <div className="space-x-2">
            <input type="radio" id="aud" name="cat" onClick={handleForAudio} />
            <label htmlFor="aud">Audio</label>
          </div>
          <div className="space-x-2">
            <input type="radio" id="lap" name="cat" onClick={handleForLaptop} />
            <label htmlFor="lap">Laptop</label>
          </div>
          <div className="space-x-2">
            <input type="radio" id="mob" name="cat" onClick={handleForMobile} />
